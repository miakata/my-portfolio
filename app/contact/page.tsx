        ...
        <main className="min-h-screen px-6 md:px-10">
            <Container>
                ...
                <form className="space-y-8 max-w-lg">
                    <input className="w-full bg-white/5 border border-white/50 rounded-lg px-4 py-3" placeholder="Name" />
                    <input className="w-full bg-white/5 border border-white/50 rounded-lg px-4 py-3" placeholder="Email" />
                    <textarea className="w-full bg-white/5 border border-white/50 rounded-lg px-4 py-3" rows={5} placeholder="Message" />
